...
%
% Variant of getCorrelationEphysContParam_cond() that keeps track of which
%  fly the data comes from and allows normalization of spike rate (as
%  fraction of max spike rate (max as percentile) or as change from
%  baseline (when fly isn't walking).
% 
...
%         consideration. As 2 element vector
...
%   8/11/23 - HHY
%
function getCorrelationEphysContParam_cond_fly(ephysParam, behParams, ...
