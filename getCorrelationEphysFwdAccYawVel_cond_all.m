% getCorrelationEphysFwdAccYawVel_cond_all.m
%
% Wrapper function for getCorrelationEphysFwdAccYawVel_cond_fly() that 
...
%   5/15/24 - HHY
%
function getCorrelationEphysFwdAccYawVel_cond_all(ephysParam, cond, ...
    ...
    save(fullSavePath, 'fwdAccVals', 'yawVelVals', 'ephysVals', ...
        'ephysValsNorm', 'ephysParam', 'tDelay', 'fwdAccFilt', ...
        'sampRate', 'notMoveExclDur', 'postStimExclDur', 'cond', ...
        'normSpikeRate', '-v7.3');
