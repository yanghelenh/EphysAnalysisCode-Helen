...
%  FicTrac parameters and heatmap relating spike rate/voltage to forward
...
% UPDATED: 9/16/20 - HHY
%
function [kernels, kernelParams, heatmapMat] = computeKernelsHeatmap_pData()
