% getCorrelationEphysContParam.m
%
...
%   8/7/23 - HHY
%
function getCorrelationEphysContParam(ephysParam, behParams, legs, ...
    tDelay, notMoveExclDur, postStimExclDur, pDataPath, pDataFNames, ...
