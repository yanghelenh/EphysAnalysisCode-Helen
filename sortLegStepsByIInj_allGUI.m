...
% Calls sortLegStepsByIInj() but operates on multiple pData files, selected
%  through GUI
%
% INPUTS:
...
%   10/26/22 - HHY
%
function sortLegStepsByIInj_allGUI(amps, durs, iInjTime, notIinjTime)
    ...
    for i = 1:numPDataFiles
        ...
        % function call
        sortLegStepsByIInj(amps, durs, iInjTime, notIinjTime, ...
            pDataFullPath);
    end
end
