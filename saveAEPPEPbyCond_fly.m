...
% Can condition on a value of legStep params
%
% INPUTS:
...
%   12/2/22 - HHY
%   12/5/22 - HHY - add SEM
%   2/14/22 - HHY - add conditioning for legStep param
%
function saveAEPPEPbyCond_fly(stim, cond, whichPhase, flipLegsLR, saveDir)
                ...
                for j = 1:length(iInjCatAmps)
                    ...
                    if ~isempty(cond)
                        [stepValX, stepValY, theseWhichLeg] = ...
                            getCatStepValsXYcond(stepAEPX, stepAEPY, ...
                            iInjCatAmps(j), iInjCatDurs(j), stepCond, ...
                            cond.cond{j}, legSteps.stepWhichLeg, ...
                    ...
                    if ~isempty(cond)
                        [stepValX, stepValY, theseWhichLeg] = ...
                            getCatStepValsXYcond(stepPEPX, stepPEPY, ...
                            iInjCatAmps(j), iInjCatDurs(j), stepCond, ...
                            cond.cond{j}, legSteps.stepWhichLeg, ...
                            thisLegStepCat, legStepsByIinj.iInjCatAmps, ...
                            legStepsByIinj.iInjCatDurs);
            ...
            if (any(contains(pDataVarsNames, 'legSteps')) && ...
                ...
                for j = 1:length(optoCatNDs)
                    ...
                    if ~isempty(cond)
                        [stepValX, stepValY, theseWhichLeg] = ...
                            getCatStepValsXYcond(stepAEPX, stepAEPY, ...
                            optoCatNDs(j), optoCatDurs(j), stepCond, ...
                            cond.cond{j}, legSteps.stepWhichLeg, ...
                            thisLegStepCat, ndKey, ...
                            legStepsByOpto.optoCat);
                    else
                        % get values for just this condition
                        [stepValX, stepValY, theseWhichLeg] = ...
